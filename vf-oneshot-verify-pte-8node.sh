#!/bin/bash
##vf-oneshot-verify-pte-8node.sh
...
CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch --num-processes 4 --config-file configs/zero3.yaml verifiers/examples/oneshot_verify_pte_8node.py