...
CUDA_VISIBLE_DEVICES=3,4 accelerate launch --config-file configs/zero3.yaml verifiers/examples/oneshot_verify_pte_8node.py
"""
...
run_name = "oneshot-grpo-pte_" + model_name.split("/")[-1].lower()
